...
import { CheckCircle, ShoppingBag, ArrowRight, ExternalLink, ShieldAlert, CreditCard } from "lucide-react";
    ...
    <Card className="w-full max-w-2xl border-none bg-card/40 backdrop-blur-3xl shadow-3xl rounded-[2.5rem] overflow-hidden ring-1 ring-white/10">
      ...
      <CardContent className="space-y-8 px-10 pb-12 pt-8">
        ...
        <div className="pt-6 border-t border-white/10 flex justify-center">
          <Button asChild variant="ghost" className="text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-white transition-all">
            <Link href="/account">
               Ver estado de mis compras <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </Button>
        </div>
      </CardContent>
